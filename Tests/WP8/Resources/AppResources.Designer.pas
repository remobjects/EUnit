...
namespace Echoes.Tests.WP8.Resources;
...
begin
    if System.Object.ReferenceEquals(resourceMan, nil) then begin
        var temp: System.Resources.ResourceManager := new System.Resources.ResourceManager('Echoes.Tests.WP8.Resources.AppResources', typeOf(AppResources).Assembly);
        resourceMan := temp;
    end;
    exit(resourceMan);
end;
